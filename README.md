...
Not (yet) ported: line/candle morph transition, window-change transition, built-in window/mode/series toggle controls (build these in SwiftUI/UIKit around the view; batch 3 adds SwiftUI equivalents).
